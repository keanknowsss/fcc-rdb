...
--
-- Name: properties properties_elements_atomic_number_foreign_key; Type: FK CONSTRAINT; Schema: public; Owner: freecodecamp
--

ALTER TABLE ONLY public.properties
    ADD CONSTRAINT properties_elements_atomic_number_foreign_key FOREIGN KEY (atomic_number) REFERENCES public.elements(atomic_number);


--
-- Name: properties properties_types_type_id_foreign_key; Type: FK CONSTRAINT; Schema: public; Owner: freecodecamp
--

ALTER TABLE ONLY public.properties
    ADD CONSTRAINT properties_types_type_id_foreign_key FOREIGN KEY (type_id) REFERENCES public.types(type_id);
